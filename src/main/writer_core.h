...
#define PRIMARY_FOLDER_NUM 128   /*the root directory of our file system has 128 primary folders*/
#define SECONDARY_FOLDER_NUM 128 /*every primary folder contains 128 secondary folders*/
